export const ui = {
  ru: {
    ...
    'consent.text': 'Мы используем Яндекс.Метрику, чтобы улучшать сайт.',
    'consent.accept': 'Принять',
    'consent.decline': 'Без аналитики',
    ...
    'cta.contact.heading': 'Выберите способ связи',
  },
  en: {
    ...
    'consent.text': 'We use Yandex.Metrica to improve the site.',
    ...
    'cta.contact.heading': 'Choose a contact method',
  },
} as const;
